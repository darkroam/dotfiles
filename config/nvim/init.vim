...
" Installing plugins
let g:coc_global_extensions = ['coc-python', 'coc-vimlsp', 'coc-snippets', 'coc-tsserver', 'coc-yank', 'coc-lists', 'coc-gitignore']
...
if has_machine_specific_file == 0
  exec "vim ~/.config/nvim/_machine_specific.vim"
endif
